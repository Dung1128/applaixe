...
class ViewDanhSachHuy extends Component {
	...
	_TimCho(bvh_id_can_chuyen, nameGiuongXepCho, price, diemA, diemB) {
		Actions.ViewSoDoGiuong({data: {chuyenVaoCho: true, huy: 'true', nameGiuongXepCho: nameGiuongXepCho, bvh_id_can_chuyen: bvh_id_can_chuyen, notId: this.props.data.notId, day:this.props.data.day, notTuyenId: this.props.data.notTuyenId, bvv_price: price, bvv_bex_id_a: diemA, bvv_bex_id_b: diemB}});
	}
